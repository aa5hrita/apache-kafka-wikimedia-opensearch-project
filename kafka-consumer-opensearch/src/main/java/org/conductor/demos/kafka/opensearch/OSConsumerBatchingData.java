...
// at least ONCE strategy - committing only after processing a batch of messages consumed during poll()

public class OSConsumerBatchingData {

    public static void main(String[] args) throws IOException {

        Logger log = LoggerFactory.getLogger(OSConsumerBatchingData.class.getSimpleName());
