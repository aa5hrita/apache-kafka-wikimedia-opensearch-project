...
// send ID into OS to make consumer idempotent so that a msg is not committed twice into OS
public class OpenSearchIdempotentConsumer {

    public static void main(String[] args) throws IOException {

        Logger log = LoggerFactory.getLogger(OpenSearchIdempotentConsumer.class.getSimpleName());
